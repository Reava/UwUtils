...
**Info**: There are currently 48 Udon Scripts in UwUtils! This will continue to expand as I find more ideas.
...
- **[Object State Relay](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/OnObjectStateRelay.cs)**
...
- **[Player Teleporter](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/PlayerTeleporter.cs)**:
Literally just TPs you on interact, that's it.
- **[Objects Toggle](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/ObjectsToggle.cs)**:
Toggles the state of an array of GameObjects & is persistence ready!
- **[Object State Setter](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/ObjectStateSetter.cs)**:
...
- **[Tag Assigner](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/TagAssigner.cs)**:
...
- **[Tag TP](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/TagTP.cs)**:
...
- **[ReflectionProbeController](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/ReflectionProbeController.cs)**:
...
- **[Spinny](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/Spinny.cs)**:
...
- **[Unity Fog Toggle](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/UnityFogToggle.cs)**:
Just an interact toggle that toggles ON/OFF Unity's fog... that's it. Call it with a trigger or a UI button, it'll work.
- **[Scene Initializer](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/SceneInitializer.cs)**:
...
- **[Tag Setter](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/tagSetter.cs)**:
Set a pre determined tag to the local user on interact. that's it.
- **[Tag Debugger](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/TagDebugger.cs)**:
...
- **[Tag Array TP](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/TagArrayTP.cs)**:
...
- **[Event Relay](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/EventRelay.cs)**:
...
- **[Udon Keybinds](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/UdonKeybinds.cs)**:
...
- **[Animator Driver](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/AnimatorDriver.cs)**:
Inverts a boolean on an animator on interact... and that's it (Persistence ready!)
- **[Trigger Zone Relay](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/TriggerZoneRelay.cs)**:
...
- **[Playercount To Animator](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/PlayercountToAnimator.cs)**:
...
- **[Join Bell](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/JoinBell.cs)**:
...
- **[Toggle Canvas](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/ToggleCanvas.cs)**:
Same as iState, but for Canvas components
- **[MeshRenderer Swapper](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/MeshRendererSwapper.cs)**:
...
- **[Instance Creator Relay](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/InstanceCreatorRelay.cs)**:
Sends a custom event of your choice to Udon Behaviors if the local user just created the instance
- **[Fading TP](https://github.com/Reava/UwUtils/tree/main/FadingTP)**:
...
- **[Spawn Fade](https://github.com/Reava/UwUtils/tree/main/SpawnFade)**:
...
- **[Remote String To Text](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/RemoteStringToText.cs)**:
...
- **[Sequencial Toggle](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/.cs)**:
...
- **[Advanced UI Toggle](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/AdvancedUIToggle.cs)**:
...
- **[Collectible](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/Collectible.cs)**:
When interacted with, can send a value to the [Collection System](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/CollectionSystem.cs) to add to the balance of it
- **[Collection System](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/CollectionSystem.cs)**:
The brain that receives events from [Collectibles](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/Collectible.cs) and adds up all the values received, can output to mulitple text displays
- **[Multi UI Toggle Manager](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/MultiUIToggleManager.cs)**:
...
- **[Multi UI Slider Manager](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/MultiUISliderManager.cs)**:
...
- **[PostProcessing Controller](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/PostProcessingController.cs)**:
Controls the post processing weight based on a slider or [Slider Manager](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/MultiUISliderManager.cs) for multiple sliders controlling the same value.
- **[Slider Saver](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/SliderSaver.cs)**
...
- **[Audiolinked Animator](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/AudiolinkedAnimator.cs)**
...
- **[Environmental Light Switch](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/EnvironmentalLightingSwitch.cs)**
Enables toggling the Lighting Mode of the scene.
- **[Skybox Toggle](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/SkyboxToggle.cs)**
Enables Switching between two Skyboxes
- **[Unity Fog Color Setter](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/UnityFogColorSetter.cs)**
Enables Setting the color of the fog.
- **[Unity Fog Settings](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/UnityFogSettings.cs)**
Enables switching between two presets of Fog settings.
- **[Canvas Group Toggle](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/CanvasGroupToggle.cs)**
Enables toggling a UI Canvas Group ON/OFF (1 / 0 Opacity) with or without smooth transition. (_Toggle, _SetOn, _SetOff)
- **[InteractionTextSetter](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/InteractionTextSetter.cs)**
Allows changing the interaction text on the referenced scripts (_ToggleText, _SetText, _ResetText)
- **[Image Color Setter](https://github.com/Reava/UwUtils/blob/main/Runtime/Scripts/ImageColorSetter.cs)**
